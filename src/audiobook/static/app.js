...
document.querySelector('#job-form').addEventListener('submit', async event => {
  ...
  const body = { novel_url:document.querySelector('#novel-url').value, title:document.querySelector('#title').value || null, chapter_limit:limit ? Number(limit) : null, language:document.querySelector('#language').value, speaker:document.querySelector('#speaker').value, voice_instruction:document.querySelector('#instruction').value };
